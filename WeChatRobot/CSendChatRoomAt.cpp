...
CSendChatRoomAt::CSendChatRoomAt(LPCTSTR TempWxid, LPCTSTR TempNickName, LPCTSTR TempChatRoomid,
                                 CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_SENDAT, pParent), m_msg(_T("")), m_MemberWxid(TempWxid), m_MemberNickName(TempNickName)
	  , m_ChatRoomid(TempChatRoomid)
{
}
