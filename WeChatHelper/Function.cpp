...
void GetInformation()
{
	...
	//发送到客户端
	HWND hInformation = FindWindow(nullptr, L"Information");
	if (hInformation == nullptr)
	{
		MessageBoxA(nullptr, "未查找到Information窗口", "错误", MB_OK);
		return;
	}
...
wchar_t* UTF8ToUnicode(const char* str)
{
	int textlen = 0;
	wchar_t* result;
	textlen = MultiByteToWideChar(CP_UTF8, 0, str, -1, nullptr, 0);
